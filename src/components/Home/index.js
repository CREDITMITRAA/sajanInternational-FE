      ...
      <div className="space-y-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-4 items-center md:ml-4">
              <div className="order-2 md:order-1 md:col-span-8 bg-white rounded-xl shadow-md border border-white p-6">
                <p
                  ...
                  style={{ color: "#051414" }}
                >
                  We believe that financial access should be a right, not a
                  privilege. Whether it’s funding a dream business, managing
                  personal expenses, or handling unexpected financial needs, we
                  make borrowing simple, transparent, and accessible to all. Our
                  loan solutions are designed to cater to individuals and
                  businesses, ensuring that financial limitations never stand in
                  the way of growth and success.
                  <br />
                  <br />
                  Since our inception in 1980, we have been committed to
                  bridging financial gaps and providing opportunities for those
                  who need them the most. With a customer-first approach,
                  state-of-the-art technology, and quick processes, we strive to
                  make lending stress-free. As we continue to grow, our vision
                  is to become a trusted financial platform that empowers
                  millions, helping them achieve their goals and build a
        ...
        <section className="max-w-6xl mx-auto px-4">
          ...
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-2 md:gap-4">
            ...
            {/* Right Side Content */}
            <div
              className="w-full md:w-[669px] bg-white border border-white rounded-[16px] p-4 text-base font-normal font-roboto leading-normal"
              style={{ color: "#051414" }}
            >
              In today’s fast-paced world, financial flexibility of salaried
              employees is necessary. Our NBFC is committed to providing instant
              personal loans designed to meet the unique needs of working
              professionals. Whether you need funds for an emergency, a dream
              vacation, home renovation, or any personal requirement, we ensure
              the easiest borrowing experience because we believe in financial
              freedom.
              <br />
              We understand that time is valuable, especially for corporate
              employees with demanding schedules. That’s why our loan process is
              quick, transparent, and convenient. With competitive interest
              rates, flexible repayment options, and zero hidden charges, we
              make borrowing stress free.
              <br />
              Our goal is to empower professionals by giving them the financial
              freedom they deserve. No more waiting for lengthy approval
              processes—our advanced technology ensures seamless loan disbursal
              directly to your account. Whether it’s for career growth,
              education, or managing unforeseen expenses, we have you covered.
              <br />
              With our lending solutions, we bring a new way of borrowing to
              help you achieve your financial aspirations. Experience a smarter,
              more reliable, and efficient way to access instant personal
              loans—because financial well-being matters the most!
            </div>
          </div>
          {/* </section> */}
        </section>
        ...
        <section className="w-full md:px-16">
          <div className="max-w-6xl mx-auto text-center">
            <h2 className="text-2xl sm:text-4xl font-bold font-roboto text-[#061B4E] mb-2">
              Quick & Hassle-Free Way to{" "}
              <span className="text-[#FF9E28]">Secure Your Loan</span>
            </h2>
            <div
              className="text-base md:text-xl font-medium font-roboto leading-normal mb-6"
              style={{ color: "#051414" }}
            >
          ...
          <div className="md:space-y-0 space-y-4">
            ...
            <div className="w-full flex md:flex-row flex-col md:space-y-0 space-y-2">
              ...
              <div className="md:w-3/5 p-8 bg-white md:rounded-none md:rounded-t-xl md:rounded-br-xl rounded-xl shadow-lg">
                <h1 className="font-bold text-xl text-orange-400 mb-2 font-roboto">
                  Customer-Centric Approach
                </h1>
                <p style={{ color: "#051414" }}>
                  At Sajan International, customers are at the heart of
                  everything we do. We prioritize financial needs by offering
                  easy loan solutions, seamless processes, and transparent
                  terms. Our goal is to build long-term relationships by
                  providing exceptional service and ensuring a hassle-free
            ...
            <div className="w-full flex md:flex-row-reverse flex-col md:space-y-0 space-y-2">
              ...
              <div className="md:w-3/5 p-8 bg-white md:rounded-none md:rounded-l-xl rounded-xl shadow-lg font-roboto">
                ...
                <p style={{ color: "#051414" }}>
                  We believe in complete transparency, ensuring customers have
                  clarity on loan terms, interest rates, and repayment
                  structures. There are no hidden charges or misleading
                  policies—just honest and straightforward financial solutions.
                  Trust is the foundation of our business, and we work hard to
                  maintain it with every transaction.
                </p>
              </div>
            </div>
            ...
            <div className="w-full flex md:flex-row flex-col md:space-y-0 space-y-2">
              ...
              <div className="md:w-3/5 p-8 bg-white md:rounded-none md:rounded-r-xl rounded-xl shadow-lg">
                ...
                <p style={{ color: "#051414" }}>
                  Our mission is to make financial assistance accessible to
                  everyone, regardless of background or credit history. We
                  strive to bridge the gap between dreams and reality by
                  providing fair and inclusive loan opportunities, empowering
                  individuals to grow without financial constraints.
                </p>
              </div>
            </div>
            ...
            <div className="w-full flex md:flex-row-reverse flex-col md:space-y-0 space-y-2">
              ...
              <div className="md:w-3/5 p-8 bg-white md:rounded-none md:rounded-l-xl md:rounded-br-xl rounded-xl shadow-lg">
                ...
                <p style={{ color: "#051414" }}>
                  As we expand, we continuously evolve our technology, services,
                  and offerings to better serve customers. By embracing
                  innovation, we simplify lending processes, enhance customer
                  experiences, and ensure that borrowing remains fast, secure,
                  and convenient for everyone who trusts us with their financial
                  needs.
                </p>
              </div>
            </div>
