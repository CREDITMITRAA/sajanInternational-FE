          ...
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center gap-2">
            ...
            <div className="w-full md:w-4/5">
              <p className="text-gray-800 text-sm leading-tight bg-white p-6 rounded-xl shadow-2xl">
                In today’s fast-paced world, financial flexibility for salaried
                employees is necessary. Our NBFC is created by professionals
                with personal needs-designed tools to meet the unique needs of
                working professionals. Whether you need funds for an emergency,
                a dream vacation, home renovation, or any personal milestone, we
                ensure you access to solutions with ease and convenience rooted
                in financial freedom.
                <br />
                <br />
                We understand that time is valuable, especially for corporate
                and government sector employees with busy schedules. That’s why
                our loan process is quick, transparent, and convenient —
                offering competitive rates and simple repayment options. No
                matter your profession or goals, we make borrowing stress-free.
                <br />
                <br />
                Our aim is to empower professionals by giving them the financial
                freedom they deserve. It’s our way of saying that for highly
                aspirational and educated knowledge workers, accessible loans
                delivered directly to your account are essential. Whether it’s
                for career growth, education, or managing personal
                responsibilities — we’ve got you covered.
                <br />
                <br />
                We believe in making dreams real, and we’re constantly
                innovating to help you achieve your financial aspirations
                faster. Join the growing number of professionals who enjoy a
                secure, reliable, and personal loaner — because financial
                wellbeing matters the most!
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="w-full md:px-16">
          <div className="max-w-6xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold font-roboto text-blue-900 mb-2">
              ...
              <span className="text-orange-500">Secure Your Loan</span>
            </h2>
